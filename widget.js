...
function ClearPathMotor(motId) {
    ...
    this.refreshDisplay = function() {
        ...
        for (stateOption in motorStateEnum) {
              $(indicatorIdStr).toggleClass(motorStateEnum[stateOption],motorStateEnum[stateOption]==this.state);
        }
    }
                    ...
                    if ('P' in d && d.P == this.options.port && 'D' in d && d.D !== undefined) {
                        ...
                        if (this.data.match(/\r{0,1}\n/)) {
                            ...
                            if (null!= line && line.charAt(0)=="[") {
                                ...
                                for (var i = 0; i<this.motorIdArr.length; i++) {
                                    ...
                                    switch (state) {
                                        ...
                                        case "*":
                                            ...
                                            this.soundTheAlarm("Motor is in error: "+motId);
                                            break;
                                        default:

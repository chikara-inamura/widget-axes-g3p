...
cpdefine("inline:com-chilipeppr-widget-xyz", ["chilipeppr_ready", "jquerycookie"], function () {
    return {
        ...
        init: function () {
            ...
            // Subscribe to controller status updates, used by homing mechanism to queue commands for axis-by-axis homing
            chilipeppr.subscribe("/com-chilipeppr-interface-cnccontroller/status", this, this.controllerStatus);
            
            chilipeppr.subscribe("/com-chilipeppr-widget-serialport/ws/recv", this, this.onWsRecvMotMonitor);
...
//                        if (this.data.match(/\r{0,1}\n/)) {
                            ...
                            if (null!= line && line.charAt(0)=="[") {
                                ...
                                switch (line.charAt(1)) {
                                    case "1":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathX').css('background-color', 'green');
                                        break;
                                    case "0":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathX').css('background-color', 'yellow');
                                        break;
                                    case "*":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathX').css('background-color', 'red');
                                        break;
                                    default:
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathX').css('background-color', 'purple');
                                        break;
                                }
                                switch (line.charAt(2)) {
                                    case "1":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathXp').css('background-color', 'green');
                                        break;
                                    case "0":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathXp').css('background-color', 'yellow');
                                        break;
                                    case "*":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathXp').css('background-color', 'red');
                                        break;
                                    default:
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathXp').css('background-color', 'purple');
                                        break;
                                }
                                switch (line.charAt(3)) {
                                    case "1":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathY').css('background-color', 'green');
                                        break;
                                    case "0":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathY').css('background-color', 'yellow');
                                        break;
                                    case "*":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathY').css('background-color', 'red');
                                        break;
                                    default:
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathY').css('background-color', 'purple');
                                        break;
                                }
                                switch (line.charAt(4)) {
                                    case "1":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathZ').css('background-color', 'green');
                                        break;
                                    case "0":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathZ').css('background-color', 'yellow');
                                        break;
                                    case "*":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathZ').css('background-color', 'red');
                                        break;
                                    default:
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathZ').css('background-color', 'purple');
                                        break;
                                }
                                switch (line.charAt(5)) {
                                    case "1":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathA').css('background-color', 'green');
                                        break;
                                    case "0":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathA').css('background-color', 'yellow');
                                        break;
                                    case "*":
                                        $('#com-chilipeppr-widget-xyz-ftr .resetclearpathA').css('background-color', 'red');
                                        break;
                                    default:
        ...
        getPortListCallback: function(data) {
            ...
            console.log("data:", data);
            var portlist = $('.com-chilipeppr-widget-xyz-motorport');
            portlist.empty();
